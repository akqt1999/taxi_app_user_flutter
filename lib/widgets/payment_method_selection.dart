                    ...
                    children: [
                      Container(
                        ...
                        child: FlatButton.icon(
                            ...
                            label: CustomText(text: "With Card",  weight: FontWeight.normal,color: black, size: 19,)),
                      ),
                      Container(
                        decoration: BoxDecoration(
                        ...
                        child: FlatButton.icon(
                            ...
                            label: CustomText(text: "With Cash",   weight: FontWeight.normal,color: black, size: 19,)),
                      ),
                    ],
                  ),
                ),
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            CustomText(
                                              ...
                                              weight: FontWeight.normal,color: black, size: 19,),
                                          ],
                                        ),
                                        SizedBox(
                                          height: 30,
                                          ...
                                          children: [
                                            FlatButton(
                                                ...
                                                child: CustomText(
                                                  text: "Cancel Request",
                                                  color:
                                                  Colors.deepOrange, weight: FontWeight.normal, size: 18,
                                                )),
                                          ],
                                        )
                                      ],
