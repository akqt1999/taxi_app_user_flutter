...
import 'package:taxi_app_user_flutter/helpers/constants.dart';
import 'package:taxi_app_user_flutter/helpers/style.dart';
import 'package:taxi_app_user_flutter/models/driver.dart';
import 'package:taxi_app_user_flutter/models/ride_Request.dart';
import 'package:taxi_app_user_flutter/models/route.dart';
import 'package:taxi_app_user_flutter/models/user.dart';
import 'package:taxi_app_user_flutter/services/drivers.dart';
import 'package:taxi_app_user_flutter/services/map_requests.dart';
import 'package:taxi_app_user_flutter/services/ride_requests.dart';
import 'package:taxi_app_user_flutter/widgets/custom_btn.dart';
import 'package:taxi_app_user_flutter/widgets/custom_text.dart';
import 'package:taxi_app_user_flutter/widgets/stars.dart';
...
//  this stream is for all the driver on the app
  StreamSubscription<List<DriverModel>> allDriversStream;
   ...
   // pickupCoordinates la diem ban dau
    LatLng pickupCoordinates;
    // destinationCoordinates la diem den
...
//         onResume: handleOnResume);
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((event) {
      handleOnLaunch(event.data);
    });
    FirebaseMessaging.instance.getInitialMessage().then((value) {
      if(value!=null)
      handleOnResume(value.data);
    });
...
// ANCHOR: MAPS & LOCATION METHODS
      ...
      if (_markers.isNotEmpty) {
        _markers.forEach((element) async {
          if (element.markerId.value == PICKUP_MARKER_ID) {
            ...
            pickupLocationControlelr.text = placemark[0].street;
            notifyListeners();
          }
        });
      }
  ...
  Future sendRequest({ LatLng origin,  LatLng destination}) async {
    ...
    RouteModel route = await _googleMapsServices.getRouteByCoordinates(_org, _dest);
    routeModel = route;
                  ...
                  Row(
                    ...
                    children: [
                      CustomBtn(
                        ...
                        onTap: () {},
                        bgColor: green,
                        shadowColor: Colors.green, txtColor: black,
                      ),
                      CustomBtn(
                        text: "Cancel",
                        onTap: () {},
